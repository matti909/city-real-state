  ...
  template: `
    ...
    >
      <div class="flex flex-col justify-center items-center">
        <div class="border-2 border-solid rounded-[56px] border-slate-300">
          <div
            class="px-8 py-20 w-full bg-surface-0 dark:bg-surface-900 sm:px-20"
          ...
          >
            ...
            <div>
              ...
              <div class="flex gap-8 justify-between items-center mt-2 mb-8">

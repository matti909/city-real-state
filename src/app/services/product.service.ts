...
interface Property {
  ...
  category: string;
  quantity: number;
  inventoryStatus: 'VENTA' | 'ALQUILER' | 'VENTA/PERMUTA';
  rating: number;
}
    ...
    return [
      {
        ...
        description:
          'Hermosa casa ubicada en un bosque tranquilo, ideal para descansar.',
        image: 'casa-bosque.jpg',
        price: 350000,
        category: 'Residencial',
        quantity: 1,
        inventoryStatus: 'VENTA',
        rating: 5,
      },
      {
        id: '1001',
        ...
        description:
          'Moderno apartamento en el corazón de la ciudad, cerca de todo.',
        image: 'apartamento-ciudad.jpg',
        price: 250000,
        category: 'Residencial',
        quantity: 3,
        inventoryStatus: 'ALQUILER',
        rating: 4,
      },
      {
        id: '1002',
        code: 'PROP003',
        name: 'Oficina en Zona Comercial',
        description:
          'Amplia oficina en una zona comercial de alto tráfico, perfecta para negocios.',
        image: 'oficina-comercial.jpg',
        price: 500000,
        category: 'Comercial',
        quantity: 2,
        inventoryStatus: 'ALQUILER',
      ...
      },
      {
        id: '1003',
        code: 'PROP004',
        name: 'Terreno en la Montaña',
        description:
          'Terreno con vista panorámica a las montañas, ideal para construir tu hogar.',
        image: 'terreno-montana.jpg',
        price: 150000,
        category: 'Terrenos',
        quantity: 5,
        inventoryStatus: 'VENTA/PERMUTA',
        rating: 4,
      },
      {
        id: '1004',
        ...
        name: 'Casa de Playa',
        description:
          'Acogedora casa frente al mar, con acceso directo a la playa.',
        image: 'casa-playa.jpg',
        price: 600000,
        category: 'Residencial',
        quantity: 1,
        inventoryStatus: 'VENTA/PERMUTA',
